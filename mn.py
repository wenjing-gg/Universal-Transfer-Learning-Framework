...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=2, no_cuda=False):
        ...
        self.fc = nn.Linear(512 * block.expansion, num_classes)  # 输出2个类别
...
def resnet34(num_classes=2, **kwargs):
    """Constructs a ResNet-34 model for binary classification."""
